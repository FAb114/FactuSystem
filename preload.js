...
contextBridge.exposeInMainWorld('api', {
  ...
  // ✅ NUEVA función para abrir módulos como ventanas independientes
  openModule: (moduleId) => {
    ipcRenderer.invoke('open-module', moduleId);
  }
});
...
window.electronAPI.preloadLoaded = true;
window.electronAPI.preloadLoadedTime = new Date().toISOString();